...
if __name__ == "__main__":
    ...
    #-------------------------------------------------------------------------#
    video_name = "MVI_39401_25"
    video_path      = r'D:\Desktop\%s.mp4'%(video_name)
    video_save_path = r"D:\Desktop\out\%s_out.mp4"%(video_name)
    video_fps       = 25
    ...
    if mode == "predict":
        ...
        while(True):
            ...
            frame = cv2.putText(frame, "cars_num = %d" % (len(cars)), (0, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
