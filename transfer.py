                ...
                if target.tag == "target":
                    ...
                    for target_child in target:
                        ...
                        if (target_child.tag == "attribute"):
                            ...
                            set_car.add(target_child.attrib["vehicle_type"])
                            set_color.add(target_child.attrib["color"])
                            name.appendChild(doc.createTextNode(target_child.attrib["vehicle_type"]))
                            color.appendChild(doc.createTextNode(target_child.attrib["color"]))  # 随意指定
...
if (__name__ == "__main__"):
    # print("main")
    basePath = "DETRAC-Train-Annotations-XML-v3"
    ...
    print(len(set_car), set_car)
    print(len(set_color), set_color)

    log.write(str(total_num) + "\n")
    visualization_image("data/img00001.jpg", "xml_train/MVI_20011__img00001.xml")